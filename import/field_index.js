...
exports.org_code_fields = ['SCHOOL', 'School Code', 'SCH_CODE', 'SCHOOL_CODE', 'DIST_CODE', 'ORG_CODE', 'DIST_SCHOOL_CODE', 'DISTRICT_CODE', '"District Code"', 'District Code', 'org_code', 'Org_code', 'Org Code']
...
exports.year_fields =  ['FY_CODE', 'REC_YEAR', 'ORG_FY', 'GRADUATING_YEAR', 'YEAR', 'SY', 'FY', 'Year', 'adminyear', 'Graduating Year']
