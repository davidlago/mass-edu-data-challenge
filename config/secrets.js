...
module.exports = {
  ...
  facebook: {
    clientID: process.env.FACEBOOK_ID || '312840662215037',
    clientSecret: process.env.FACEBOOK_SECRET || '415ab348c8d23dc6b7ccdfedd05cc044',
  ...
  github: {
    clientID: process.env.GITHUB_ID || '1ec896785a3071e02bff',
    clientSecret: process.env.GITHUB_SECRET || '7abdca347482cd7c13c419fa94c2391ae1ce6425',
